            ...
            <section class="panel">
                <div class="panel-body">
                    <div class="thumb-info mb-md">
                        <img src="{{$user->avatar}}" class="rounded img-responsive" alt="John Doe">
                        ...
                        <ul class="simple-user-list">
                            <li>
                                <figure class="image rounded">
                                    <img src="{{ asset('images/admin/!sample-user.jpg') }}" alt="Joseph Doe Junior" class="img-circle">
                                </figure>
                            ...
                            <li>
                                <figure class="image rounded">
                                    <img src="{{ asset('images/admin/!sample-user.jpg') }}" alt="Joseph Junior" class="img-circle">
                                </figure>
                            ...
                            <li>
                                <figure class="image rounded">
                                    <img src="{{ asset('images/admin/!sample-user.jpg') }}" alt="Joe Junior" class="img-circle">
                                </figure>
                    ...
                    <ul class="simple-post-list">
                        <li>
                            <div class="post-image">
                                <div class="img-thumbnail">
                                    <a href="#">
                                        <img src="{{ asset('images/admin/post-thumb-1.jpg') }}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="post-info">
                        ...
                        <li>
                            <div class="post-image">
                                <div class="img-thumbnail">
                                    <a href="#">
                                        <img src="{{ asset('images/admin/post-thumb-2.jpg') }} alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="post-info">
                        ...
                        <li>
                            <div class="post-image">
                                <div class="img-thumbnail">
                                    <a href="#">
                                        <img src="{{ asset('images/admin/post-thumb-3.jpg') }}" alt="">
                                    </a>
                                </div>
                            </div>
                            <div class="post-info">
            ...
            <div class="tabs">
                ...
                <div class="tab-content">
                                    ...
                                    <li>
                                        <div class="tm-box">
                                            ...
                                            <div class="thumbnail-gallery"
                                                <a class="img-thumbnail lightbox" href="{{ asset('images/admin/projects/project-4.jpg"') }}" data-plugin-options='{ "type":"image" }'>
                                                    <img class="img-responsive" width="215" src="{{ asset('images/admin/projects/project-4.jpg') }}">
                                                    <span class="zoom">
                    ...
                    <div id="edit" class="tab-pane">
                        ...
                        <form method="POST" action="{{ route('admin.users.update', $user->id) }}" class="form-horizontal form-bordered">
                            {!! method_field('PATCH') !!}
                            {!! csrf_field() !!}
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="alias" class="form-control" type="text" value="{{ $user->alias }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            ...
                                            <label>
                                                <input name="gender[]" id="gender_male" value="1" {{ ( $user->gender == 'Male' ) ? 'checked' : '' }} type="radio">
                                                Male
                                            </label>
                                            <label>
                                                <input name="gender[]" id="gender_female" value="0" {{ ( $user->gender == 'Female' ) ? 'checked' : '' }} type="radio">
                                                Female
                                            </label>
                            ...
                            <div class="panel-footer">
                                <div class="row">
                                    <div class="col-md-9 col-md-offset-3">
                                        <button type="submit" class="btn btn-primary col-md-12">Update User</button>
                                    </div>
                                </div>
                            </div>
                        </form>
